...
pub struct SignalMessage {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ranking_basis: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct EngineStats {
    ...
    pub skip_penny_contract: u64,
    pub skip_price_cap: u64,
    pub skip_low_edge: u64,
    pub skip_volume_gate: u64,
    pub skip_chop_regime: u64,
    pub binance_ws_connected: bool,
    pub poly_ws_connected: bool,
    pub last_binance_trade_time: Option<i64>,
    pub last_polymarket_data_time: Option<i64>,
    pub last_market_info_time: Option<i64>,
    ...
    pub calibrated_scores_computed: u64,
    pub calibrated_scores_used: u64,
    pub skip_calibrated_no_ev: u64,
    pub calibrated_mode: String,
    pub calibrated_artifact_version: Option<String>,
    pub calibrated_loaded: bool,
    pub last_calibrated_prob_up: Option<f64>,
    pub last_calibrated_ev_up: Option<f64>,
    pub last_calibrated_ev_down: Option<f64>,
    pub last_calibrated_direction: Option<String>,
    pub last_ranking_basis: Option<String>,
}
