...
# Trade IDs from the private incident report were intentionally redacted in the
# public archive. Populate these placeholders locally before using --apply.
TARGET_CONDITION_IDS = {
    "REDACTED_CONDITION_ID_983",
    "REDACTED_CONDITION_ID_984",
    "REDACTED_CONDITION_ID_985",
    "REDACTED_CONDITION_ID_986",
    "REDACTED_CONDITION_ID_987",
    "REDACTED_CONDITION_ID_988",
    "REDACTED_CONDITION_ID_989",
    "REDACTED_CONDITION_ID_990",
    "REDACTED_CONDITION_ID_991",
    "REDACTED_CONDITION_ID_992",
    "REDACTED_CONDITION_ID_993",
    "REDACTED_CONDITION_ID_994",
    "REDACTED_CONDITION_ID_995",
}
