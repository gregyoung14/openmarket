...
\hypersetup{
  ...
  citecolor=blue,
  urlcolor=blue,
  pdftitle={OpenMarket: High-Frequency Polymarket Research Framework},
...
\title{%
  An Open-Source High-Frequency Data Pipeline and Machine Learning\\
  Research Framework for Polymarket Prediction Markets
}
...
\IfFileExists{assets/stats/research_stats.tex}{
  ...
  \newcommand{\OpenMarketLogisticScoreUs}{0.084}
}
...
\OpenMarketReleaseTag{}) spans 109 days, \OpenMarketTotalRows{} deduplicated
events across \OpenMarketSnapshots{} snapshots, and \OpenMarketLagPairs{}
explicit lead--lag pairs. Initial analyses establish Polymarket stylized facts
(median one-tick spreads), characterize heavy-tailed cross-venue timing with a
compact \OpenMarketLagMedian{}~ms median lag, and benchmark forecasts against
naive mid priors---multivariate logistic models yield modest AUC gains without
tradable simulated edge. We position this work as a data-and-methods release
enabling microstructure and forecasting research, not a trading-alpha claim.
\end{abstract}
